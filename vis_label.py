...
if __name__ == '__main__':
    ...
    res_list = []
    for enum_id, train_anno in tqdm.tqdm(enumerate(train_anno_list)):
                    ...
                    for img_2_inst in img_2_info['ocr_instances']:
                        ...
                        if img_1_entity_id == img_2_entity_id:
                            try:
                                res_list.append(
                                dict(
                                    img_1_path=os.path.join(train_anno_list[enum_id].strip('label.json'), img_1_info['image_name']),
                                    img_2_path=os.path.join(train_anno_list[enum_id].strip('label.json'), img_2_info['image_name']),
                                ...
                                continue
        print(train_anno)
    with open(out_train_anno, 'w')as fw:
